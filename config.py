...
MODEL = os.getenv("MODEL", "llama-3.3-70b-instruct")
...
ROUTER_AGENT_MODEL = os.getenv("ROUTER_AGENT_MODEL", "llama-3.3-70b-instruct")
NEO4J_AGENT_MODEL = os.getenv("NEO4J_AGENT_MODEL", "llama-3.3-70b-instruct")
FIWARE_AGENT_MODEL = os.getenv("FIWARE_AGENT_MODEL", "llama-3.3-70b-instruct")
SYNTHESIZER_AGENT_MODEL = os.getenv("SYNTHESIZER_AGENT_MODEL", "llama-3.3-70b-instruct")
