...
**Pattern: "What's the menu today?" or "Today's menu" or "Mensa menu" or "Show me the menu" or "Can you share the menu?"**
→ primary_intent: get_location_info (NOT knowledge_query!)
→ location: "mensa", poi_name: "mensa"
→ capabilities: [graph_location_lookup]
→ execution_strategy: parallel
→ confidence: 0.92
→ Mensa menu data is fetched from FIWARE via Neo4j building lookup (fiware_type: "Mensa"), NOT from knowledge base!
→ Examples: "What's the mensa menu today?", "Show today's menu", "Can you share the menu?", "What's for lunch at mensa?"
→ For follow-ups after discussing mensa: "today's menu?" or "share the menu" → resolve "mensa" from conversation context
...
FEW_SHOT_EXAMPLES = [
    ...
    {
        "user_query": "Can you share the today menu?",
        "conversation_context": "User previously asked about uni mensa location.",
        "expected_output": {
            "primary_intent": "get_location_info",
            "sub_intents": ["get_location_info"],
            "entities": {
